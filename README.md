...
1. 개요 : 여행 기록을 감성적인 사진과 함께 기록해 추억을 돌아보게 하는 사진 기록 어플
2. 참여 인원 : iOS 2명
3. 구현 부분
...
1. 개요 : 기존 야놀자 앱 서비스를 기반으로 같은 형태의 서비스를 만들어보는 클론 프로젝트
2. 개발 기간 : 2019.07.01 - 08.09
3. 참여 인원 : iOS 3명, 백 엔드 3명, 프론트 엔드 4명
4. 구현 기능 : 내 주변 숙소 리스트, 숙소 검색 기능, 숙소 예약 서비스
